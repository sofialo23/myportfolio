 ...
 {  
    $act_id = $_GET['id'];
      ...
      {  
           ...
           header("Location: ./succeedNewActivity.php");
 } 
      }  
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Upload an image for your activity</h4>
              </div>
              <div class="card-body">
                <form id="searchform" method="post" enctype="multipart/form-data"> <!-- start of form body for search by department-->
                  <input type="file" name="image" id="image" />  
                     <br />  
                     <input type="submit" name="insert" id="insert" value="Upload Image" class="btn btn-primary" />

                     <input type="submit" name="next" id="next" value="Skip" class="btn btn-primary" /> 
